...
newUserBtn.addEventListener('click', ()=> {
    ...
    modalTitle.innerText = "Formulario Socio/a"
    isEdit = false
    imgInput.src = "./img/logo.jpg"
    form.reset()
})
...
form.addEventListener('submit', (e)=> {
    ...
    const information = {
        picture: imgInput.src == undefined ? "/img/user.jpg" : imgInput.src,
    ...
    modalTitle.innerHTML = "LLenar Formulario"

    showInfo()

    form.reset()

    imgInput.src = "./img/user.jpg"  
